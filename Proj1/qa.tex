...
\begin{enumerate} 
    \item A circle is inscribed in a trianlge ABC. It touches the sides AB,BC and AC at the points R,P and Q respectively. If AQ=4.5cm PC=5.5cm and BR=6cm, then the perimeter of the triangle ABC is:
        ...
        \end{enumerate}
        \item A truck covers a distance of 39=84km at a certain speed. If the speed is decreased by 16km/h, it will take 2 hours more to cover the same distance. 75\% of its original speed(in km/h) is:
            \begin{enumerate}
                \item 45
                \inlineitem 54
                \item 48
